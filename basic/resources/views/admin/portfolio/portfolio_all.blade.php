            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Certificates And Courses All</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Certificates Or Courses All Data </h4>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    <th>Sl</th>
                                    <th>Certificates Or Courses Name</th>
                                    <th>Certificates Or Courses Title</th>
                                    <th>Certificates Or Courses Image</th>
                                    <th>Action</th>
